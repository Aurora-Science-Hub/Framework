...
public static class EntityBuilderExtensions
{
    public static void ConfigureForeignKey<TEntity, TId, TDependentEntity>(
        ...
        Expression<Func<TEntity, TDependentEntity?>>? navigationPropertySelector = null,
        Expression<Func<TDependentEntity, IEnumerable<TEntity>?>>? collectionNavigationExpression = null,
    ...
    private static Expression<Func<TEntity, object?>> ConvertToForeignKeyExpression<TEntity>(
        this LambdaExpression foreignKeyExpression)
    {
