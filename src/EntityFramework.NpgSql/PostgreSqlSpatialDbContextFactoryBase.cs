...
namespace AuroraScienceHub.Framework.EntityFramework.NpgSql;

/// <summary>
/// Base class for creating a database context (PostgreSQL) with spatial support.
/// </summary>
public abstract class PostgreSqlSpatialDbContextFactoryBase<TDbContext, TConnectionOptions>
